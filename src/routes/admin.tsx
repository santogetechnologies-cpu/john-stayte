...
export const Route = createFileRoute("/admin")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Executive administration control center: revenue analytics, order dispatch, inventory matrix, customer directory, managers, CMS, and audit logs." },
