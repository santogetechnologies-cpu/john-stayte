...
export const Route = createFileRoute("/manager")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manager portal for order approval, delivery operations, inventory reorder alerts, customer enquiries, and performance metrics." },
      { property: "og:title", content: "Manager Portal | John Stayte Services" },
      { property: "og:description", content: "Approve orders, track truck deliveries and manage depot stock." },
    ],
  }),
