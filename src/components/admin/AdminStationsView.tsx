...
export const ALL_EXISTING_STATIONS = [
  {
    ...
    services: "Fuel Pumps, Autogas LPG, Convenience Store, Air Pressure, AdBlue, Cylinder Exchange",
  ...
  },
  {
    ...
    services:
      "Texaco Supreme Fuel, Autogas LPG, Car Wash & Jet Wash, Air Pressure & Screen Wash, Stonehouse Autoparts & Londis, Calor Gas Cylinders, Coal & Solid Fuel Logs, HGV High-Flow Pumps, Wash.ME 24/7 Laundry",
