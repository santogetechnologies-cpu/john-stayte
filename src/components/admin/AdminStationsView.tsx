...
export const ALL_EXISTING_STATIONS = [
  {
    ...
    services: "Fuel Pumps, Auto Gas, Convenience Store, Air Pressure, AdBlue, Cylinder Exchange",
  ...
  },
  {
    ...
    services:
      "Fuel Pumps, HGV / Large Vehicle Pumps, Car Wash, Air Pressure & Tyre Inflation, Convenience Store & Shop, Auto Gas, Cylinder Exchange, Easy Vehicle Access, Forecourt & Customer Parking, AdBlue Dispenser",
  ...
  },
  {
    ...
    services:
      "Texaco Supreme Fuel, Auto Gas, Car Wash & Jet Wash, Air Pressure & Screen Wash, Stonehouse Autoparts & Londis, Calor Gas Cylinders, Coal & Solid Fuel Logs, HGV High-Flow Pumps, Wash.ME 24/7 Laundry",
    image: "/bridge-station-forecourt.jpg",
