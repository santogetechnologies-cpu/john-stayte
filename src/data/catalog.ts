...
export const categories: Category[] = [
  {
    ...
    name: "Gas",
    icon: "Flame",
    subs: ["Butane Cylinders", "Propane Cylinders", "Patio Cylinders", "Pub Gas"],
  },
  {
    slug: "campingaz",
    name: "Campingaz",
    icon: "Tent",
    subs: ["Refill", "Camping Equipment"],
  },
  {
    slug: "coal-logs",
    name: "Coal & Logs",
  ...
  },
  {
    ...
    name: "Gas Spares",
    icon: "Wrench",
    subs: ["Butane Regulators", "Propane Regulators", "Changeover Valves"],
  },
  { slug: "garden", name: "Garden", icon: "Sprout", subs: [] },
  { slug: "food", name: "Food", icon: "Utensils", subs: ["Local Forecourt Produce", "Wild Bird Seed & Treats"] },
...
export const products: Product[] = [
  ...
  {
    id: "prod-free-range-eggs",
    slug: "free-range-eggs",
    name: "Free Range Eggs",
    brand: "Local Produce",
    category: "food",
    sub: "Local Forecourt Produce",
    price: 1.95,
    stock: 10,
    rating: 5.0,
    reviews: 8,
    featured: true,
    offer: false,
    image: "/food-free-range-eggs.png",
    description: "Free range eggs - half a dozen.",
    specs: {
      quantity: "Half a dozen (6 eggs)",
      type: "Free Range Eggs",
      origin: "Local Gloucestershire Farm",
    },
  },
  {
  ...
  },
  {
    ...
    specs: {
      type: "Low Pressure Propane Regulator",
      fitting: "POL Screw Fitting",
      pressure: "37mbar",
      brand: "Clesse",
    },
  },
  ...
  },
  {
    ...
    featured: true,
    offer: false,
    image: "/spares-compact-800-acov-2pack.png",
    ...
    specs: {
      type: "Automatic Changeover Valve (OPSO)",
      capacity: "2 Cylinder System",
      brand: "Clesse",
      safety: "Over Pressure Shut Off (OPSO)",
    },
  },
  {
    ...
    featured: true,
    offer: false,
    image: "/spares-compact-800-acov-4pack.png",
